...
for i,thiol in enumerate(THIOL):
        ...
        ax['SASALLW'].errorbar( CORETYPES2
                        ,coreplot
                        ,yerr=coreplotstd
                        ,elinewidth=1
                        ,capthick=0.5
...
for i,thiol in enumerate(THIOL):
        ...
        ax['SASALLH'].errorbar( CORETYPES2
                        ,coreplot
                        ,yerr=coreplotstd
                        ,capsize=CSize
                        ,elinewidth=1
...
C1datacont = make_thiol_dataset_O_C(DIRECTORY_PATH, "C1", "*thiol", "Replica*",DATA_FILE,"contact")
...
C5datacont = make_thiol_dataset_O_C(DIRECTORY_PATH, "C5", "*thiol", "Replica*",DATA_FILE,"contact")
...
N0datacont = make_thiol_dataset_O_C(DIRECTORY_PATH, "N0", "*thiol", "Replica*",DATA_FILE,"contact")
...
P1datacont = make_thiol_dataset_O_C(DIRECTORY_PATH, "P1", "*thiol", "Replica*",DATA_FILE,"contact")
...
P5datacont = make_thiol_dataset_O_C(DIRECTORY_PATH, "P5", "*thiol", "Replica*",DATA_FILE,"contact")
...
SSdatacont = make_thiol_dataset_O_C(DIRECTORY_PATH, "SS", "*thiol", "Replica*",DATA_FILE,"contact")
...
ax['AVGconthead'].errorbar(CORETYPES
...
ax['AVGconttail'].errorbar(CORETYPES
               ,[C1AVG,C5AVG,N0AVG,P1AVG,P5AVG]
               ,yerr=[C1STD,C5STD,N0STD,P1STD,P5STD]
               ,fmt='-o'
               ,capsize=CSize
